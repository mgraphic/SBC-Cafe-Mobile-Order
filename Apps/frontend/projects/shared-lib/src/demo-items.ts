import { ProductItem } from './lib/models/product.model';

export const demoItems: ProductItem[] = [
  {
    id: 1,
    name: 'Black Coffee',
    slug: 'black-coffee',
  ...
  },
  {
    ...
    price: 2,
    image:
      'https://cdn-s-www.ledauphine.com/images/E4D07D1C-6E7E-4EE4-A1E0-FF84D8296902/NW_raw/chaque-jour-les-chercheurs-ont-administre-a-des-souris-une-dose-de-cafeine-equivalente-a-environ-trois-tasses-de-cafe-chez-l-humain-photo-adobe-stock-1658238893.jpg',
  },
  {
    id: 7,
    name: 'Hot Tea',
    ...
    price: 2.15,
    image:
      'https://cdn-prod.medicalnewstoday.com/content/images/articles/324/324771/close-up-of-a-cup-of-tea.jpg',
  },
  {
    id: 8,
    name: 'London Fog Tea Latte',
    slug: 'london-fog-tea-latte',
    price: 3,
    image:
      'https://electricbluefood.com/wp-content/uploads/2021/01/london-fog-tea-latte-03.jpg',
  },
  {
    id: 9,
    name: 'Chai Tea Latte',
    ...
    price: 3.5,
    image:
      'https://www.allrecipes.com/thmb/MCdBf6nSW7JVmpdFbc8LeaxWYAQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/222513-chai-tea-latte-ddmfs-3x4-13181362-b0a92ea6efb442a4b8b7c240a7bfa9f4.jpg',
  },
];
